...
function Card() {
    return (
        <div className="flex flex-col p-10 shadow-xl  text-blue-900 rounded-lg shadow-black/50 shat w-fit">
...
export default function Main() {
    return (
        <div className="px-7 py-10 flex flex-wrap gap-5 justify-center">
            <Card />
            <Card />
            <Card />
            <Card />
